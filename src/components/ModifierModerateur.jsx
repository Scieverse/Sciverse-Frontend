        ...
        <div className="w-full relative">
            ...
            <div className="w-full py-4 px-6 flex flex-col flex-wrap justify-center content-center bg-[#dedede] font-poppins">
                <form autoComplete="off" action="post" className="w-full flex flex-col flex-wrap justify-center content-center">
                    <p className=" font-poppins text-xs pl-1 text-[#190B28] my-1">Nom:</p>
                    <input type="text" defaultValue={moder.firstName} onChange={handleChangeNom} className="py-2.5 pl-8 w-1/2 rounded-full bordre-none bg-[#E87D00] bg-opacity-25 text-base mb-4"/>
                    <p className=" font-poppins text-xs pl-1 text-[#190B28] my-1">Prenom:</p>
                    <input type="text" defaultValue={moder.lastName} onChange={handleChangePreom} className="py-2.5 pl-8 w-1/2 rounded-full bordre-none bg-[#E87D00] bg-opacity-25 text-base mb-4"/>
                    <p className=" font-poppins text-xs pl-1 text-[#190B28] my-1">Nom d'utilisateur:</p>
                    <input type="text" defaultValue={moder.username} onChange={handleChangeSurnom} className="py-2.5 pl-8 w-1/2 rounded-full bordre-none bg-[#E87D00] bg-opacity-25 text-base mb-4"/>
                    <p className=" font-poppins text-xs pl-1 text-[#190B28] my-1">Email:</p>
                    <input type="text" defaultValue={moder.email} onChange={handleChangeMail} className="py-2.5 pl-8 w-1/2 rounded-full bordre-none bg-[#E87D00] bg-opacity-25 text-base mb-10"/>
